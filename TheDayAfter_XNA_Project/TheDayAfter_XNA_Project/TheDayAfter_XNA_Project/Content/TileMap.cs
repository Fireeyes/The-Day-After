    ...
    public class TileMap
    {
        ...
        public void Draw(SpriteBatch spriteBatch)  //Doesn't do anything
        {
            ...
            {   x=0;
                foreach (Tile tile in row.Y)
                {
                    spriteBatch.Draw(texture, new Vector2(y * 64, x * 64) - new Vector2(Player.sprite.Position.X - 320, Player.sprite.Position.Y - 320), new Rectangle(tile.Id * 64, 0, 64, 64), Color.White);
